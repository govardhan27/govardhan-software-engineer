  ...
  return (
    <div className="skills-container">
      ...
      <div className="skills-section">
        <AnimatedSection animationType="animate-slide-left" rootMargin="0px 0px -50px 0px">
      ...
      <div className="skills-section">
        <AnimatedSection animationType="animate-slide-right" rootMargin="0px 0px -50px 0px">
